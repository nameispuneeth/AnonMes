...
export default function SignUp() {
    ...
    let handleSubmit = async () => {
        ...
        const res = await fetch(`${import.meta.env.VITE_APP_API_BACKEND_URL}/api/auth/signup`, {
            method: "POST",
            headers: {
        ...
        <div className="bg-[radial-gradient(circle_at_center,#2c2c2c,#0d0d0d)] flex flex-col justify-center items-center min-h-screen text-white p-6 overflow-hidden" >
            ...
            <div className="rounded-2xl shadow-lg p-10 w-full max-w-md bg-[rgba(0,0,0,0.4)] space-y-10">
                ...
                <div className="space-y-5">
                    <button className="w-full h-14 rounded-lg bg-black cursor-pointer border-2 border-gray-600 text-center text-lg font-bold" onClick={() => handleSubmit()}>{loginloading ? MSGSpinner() : "Register"}</button>
