...
export default function Home() {
    ...
    const CustomURL = async () => {
      ...
      <div style="display:flex;align-items:center;margin-top:10px;
        ...
        <span style="color:#D3D3D3; white-space: nowrap;
        overflow-x: auto;
        margin-right:0px;
        min-width: 200px;" class="custom-scrollbar">${window.location.origin}/u/</span>
        <input id="customInput" type="text" 
          placeholder="your-text"
          style="border:none;outline:none;margin-left:0px;flex:1;color:#D3D3D3" />
      </div>
    `,
